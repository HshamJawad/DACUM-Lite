...
export const translations = {
    ...
    en: {
        ...
        'settings.modalTitle':        '⚙️ Word Export Settings',
        'settings.scopeNote':         'These settings control the exported Word (.docx) file only. They are shared by all three languages and stay until you change them.',
    ...
    fr: {
        ...
        'settings.modalTitle':        '⚙️ Paramètres d\'export Word',
        'settings.scopeNote':         'Ces paramètres ne concernent que le fichier Word (.docx) exporté. Ils sont communs aux trois langues et restent actifs jusqu\'à modification.',
    ...
    ar: {
        ...
        'settings.modalTitle':        '⚙️ إعدادات تصدير Word',
        'settings.scopeNote':         'هذه الإعدادات تتحكم بشكل ملف Word (‎.docx‎) المُصدَّر فقط. وهي مشتركة بين اللغات الثلاث وتبقى حتى تغيّرها بنفسك.',
