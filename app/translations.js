...
export const translations = {
    ...
    en: {
        ...
        // ── Word export settings (modal) ──────────────────────
        // These strings describe the appearance of the EXPORTED
        // .docx file only — never the tool's own interface.
        'settings.button':            'Settings',
        'settings.modalTitle':        '⚙️ Export Settings',
        'settings.scopeNote':         'These settings control the exported files. They are shared by all three languages and stay until you change them.',
        'settings.groupColors':       'Colours',
        'settings.groupSizes':        'Font sizes',
        'settings.preview':           'Preview',
        'settings.bannerNote':        'The PDF Duties and Tasks banner uses a lighter shade of the same colour.',
        'settings.sizeScopeNote':     'Sizes apply to the Word file only. The PDF is a landscape chart with fixed-width columns and hand-calculated row heights — enlarging the font there overlaps lines and pushes text off the page.',
        'settings.previewHeading2':   'Duties and Tasks',
        'settings.titleSize':         'Main title size',
        'settings.headingSize':       'Section heading size',
        'settings.bodySize':          'Table and body text size',
        'settings.headingColor':      'Heading colour',
        'settings.tableHeaderFill':   'Table header fill',
        'settings.contrastNote':      'Text inside shaded header cells is set to white or black automatically for readability.',
        'settings.previewTitle':      'Occupation Title',
        'settings.previewHeading':    'Additional Information',
        'settings.previewTableHeader':'DUTY A: Plan the work',
        'settings.previewBody':       'Task A1: Read the drawings',
        'settings.reset':             'Reset to default',
        'settings.save':              'Save',
        'settings.close':             'Close',
        'settings.saved':             'Word export settings saved ✓',
        'settings.color.blue':        'Blue',
        'settings.color.navy':        'Navy',
        'settings.color.green':       'Dark green',
        'settings.color.maroon':      'Maroon',
        'settings.color.purple':      'Purple',
        'settings.color.darkGray':    'Dark grey',
        'settings.color.teal':        'Dark teal',
        'settings.color.black':       'Black',
        'settings.color.lightGray':   'Light grey (default)',
        ...
        'storage.titleWarn': 'Local storage is filling up',
        'storage.titleUrgent': 'Local storage is nearly full',
        'storage.subtitle': "{{used}} used — {{pct}}% of the browser's limit. Export your work to a file before you run out.",
        'storage.snapshots': 'Undo history (snapshots)',
        'storage.logos': 'Logo images',
        'storage.charts': 'Chart data',
        'storage.other': 'Other',
        'storage.unitKB': 'KB',
        'help.copyReport': 'Copy diagnostic report',
        'storage.titleOk': 'Storage usage',
        'storage.subtitleOk': '{{used}} used — {{pct}}% of the browser\'s limit. Plenty of room; you will be warned at 75%.',
        'storage.breakdownEmpty': 'Nothing stored yet',
        'storage.actClose': 'Close',
        'storage.unitMB': 'MB',
        'storage.hintSnapshots': 'Undo history is taking the most space. Clearing it for projects you have finished frees the most, and never touches chart data.',
        'storage.hintLogos': 'Logo images are taking more space than the charts themselves. Removing a logo from an old project frees space immediately.',
        'storage.actExport': 'Export this project to a file',
        'storage.actPrune': 'Clear undo history of other projects',
        'storage.actLater': 'Later',
        'storage.pruneNone': 'There are no other projects to clear.',
        'storage.pruneConfirm': 'Clear the undo history of {{n}} other project(s)? Chart data is not affected — only the ability to undo past edits in those projects.',
        'storage.pruneDone': 'Freed {{size}} from {{n}} project(s).',
        ...
        'additionalInfo.renameTitle': 'Rename section',
        'additionalInfo.clearTitle':  'Clear section',
    ...
    fr: {
        ...
        'settings.modalTitle':        '⚙️ Paramètres d\'export',
        'settings.scopeNote':         'Ces paramètres concernent les fichiers exportés. Ils sont communs aux trois langues et restent actifs jusqu\'à modification.',
        'settings.groupColors':       'Couleurs',
        'settings.groupSizes':        'Tailles de police',
        'settings.preview':           'Aperçu',
        'settings.bannerNote':        'Le bandeau Fonctions et tâches du PDF utilise une nuance plus claire de la même couleur.',
        'settings.sizeScopeNote':     'Les tailles ne s\'appliquent qu\'au fichier Word. Le PDF est un tableau en mode paysage à colonnes de largeur fixe et hauteurs de ligne calculées à la main : y agrandir la police superpose les lignes et fait déborder le texte.',
        'settings.previewHeading2':   'Fonctions et tâches',
        'settings.titleSize':         'Taille du titre principal',
        'settings.headingSize':       'Taille des titres de section',
        'settings.bodySize':          'Taille du texte des tableaux et du contenu',
        'settings.headingColor':      'Couleur des titres',
        'settings.tableHeaderFill':   'Fond des en-têtes de tableau',
        'settings.contrastNote':      'Le texte des cellules d\'en-tête passe automatiquement en blanc ou en noir pour rester lisible.',
        'settings.previewTitle':      'Titre de la profession',
        'settings.previewHeading':    'Informations complémentaires',
        'settings.previewTableHeader':'FONCTION A : Planifier le travail',
        'settings.previewBody':       'Tâche A1 : Lire les plans',
        'settings.reset':             'Réinitialiser',
        'settings.save':              'Enregistrer',
        'settings.close':             'Fermer',
        'settings.saved':             'Paramètres d\'export Word enregistrés ✓',
        'settings.color.blue':        'Bleu',
        'settings.color.navy':        'Bleu marine',
        'settings.color.green':       'Vert foncé',
        'settings.color.maroon':      'Bordeaux',
        'settings.color.purple':      'Violet',
        'settings.color.darkGray':    'Gris foncé',
        'settings.color.teal':        'Sarcelle foncé',
        'settings.color.black':       'Noir',
        'settings.color.lightGray':   'Gris clair (par défaut)',
        ...
        'storage.titleWarn': 'Le stockage local se remplit',
        'storage.titleUrgent': 'Le stockage local est presque plein',
        'storage.subtitle': '{{used}} utilisés — {{pct}} % de la limite du navigateur. Exportez votre travail avant saturation.',
        'storage.snapshots': "Historique d'annulation",
        'storage.logos': 'Images de logo',
        'storage.charts': 'Données des tableaux',
        'storage.other': 'Autres',
        'storage.unitKB': 'Ko',
        'help.copyReport': 'Copier le rapport de diagnostic',
        'storage.titleOk': 'Utilisation du stockage',
        'storage.subtitleOk': "{{used}} utilisés — {{pct}} % de la limite. Espace largement suffisant ; alerte à 75 %.",
        'storage.breakdownEmpty': 'Rien de stocké pour le moment',
        'storage.actClose': 'Fermer',
        'storage.unitMB': 'Mo',
        'storage.hintSnapshots': "L'historique d'annulation occupe le plus d'espace. L'effacer pour les projets terminés libère le plus, sans toucher aux données.",
        'storage.hintLogos': "Les logos occupent plus d'espace que les tableaux. Supprimer le logo d'un ancien projet libère de l'espace immédiatement.",
        'storage.actExport': 'Exporter ce projet dans un fichier',
        'storage.actPrune': "Effacer l'historique des autres projets",
        'storage.actLater': 'Plus tard',
        'storage.pruneNone': 'Aucun autre projet à nettoyer.',
        'storage.pruneConfirm': "Effacer l'historique d'annulation de {{n}} autre(s) projet(s) ? Les données des tableaux ne sont pas affectées.",
        'storage.pruneDone': '{{size}} libérés depuis {{n}} projet(s).',
        ...
        'additionalInfo.renameTitle': 'Renommer la section',
        'additionalInfo.clearTitle':  'Effacer la section',
    ...
    ar: {
        ...
        // ── إعدادات تصدير Word (النافذة المنبثقة) ─────────────
        'settings.button':            'الإعدادات',
        'settings.modalTitle':        '⚙️ إعدادات التصدير',
        'settings.scopeNote':         'هذه الإعدادات تتحكم بشكل الملفات المُصدَّرة. وهي مشتركة بين اللغات الثلاث وتبقى حتى تغيّرها بنفسك.',
        'settings.groupColors':       'الألوان',
        'settings.groupSizes':        'أحجام الخط',
        'settings.preview':           'المعاينة',
        'settings.bannerNote':        'شريط «الواجبات والمهام» في PDF يستخدم درجة أفتح من اللون نفسه.',
        'settings.sizeScopeNote':     'الأحجام تنطبق على ملف Word فقط. مخطط PDF أفقي بأعمدة ثابتة العرض وارتفاعات صفوف محسوبة يدوياً — وتكبير الخط فيه يجعل الأسطر تتراكب ويدفع النص خارج الصفحة.',
        'settings.previewHeading2':   'الواجبات والمهام',
        'settings.titleSize':         'حجم العنوان الرئيسي',
        'settings.headingSize':       'حجم العناوين الثانوية',
        'settings.bodySize':          'حجم خط الجدول والمحتوى العام',
        'settings.headingColor':      'لون العناوين',
        'settings.tableHeaderFill':   'لون رأس الجدول',
        'settings.contrastNote':      'يُضبط لون النص داخل خلايا رأس الجدول تلقائياً أبيض أو أسود لضمان الوضوح.',
        'settings.previewTitle':      'المهنة',
        'settings.previewHeading':    'معلومات إضافية',
        'settings.previewTableHeader':'الواجب A: تخطيط العمل',
        'settings.previewBody':       'المهمة A1: قراءة المخططات',
        'settings.reset':             'إعادة للوضع الافتراضي',
        'settings.save':              'حفظ',
        'settings.close':             'إغلاق',
        'settings.saved':             'تم حفظ إعدادات تصدير Word ✓',
        'settings.color.blue':        'أزرق',
        'settings.color.navy':        'كحلي',
        'settings.color.green':       'أخضر داكن',
        'settings.color.maroon':      'عنّابي',
        'settings.color.purple':      'بنفسجي',
        'settings.color.darkGray':    'رمادي داكن',
        'settings.color.teal':        'فيروزي داكن',
        'settings.color.black':       'أسود',
        'settings.color.lightGray':   'رمادي فاتح (الافتراضي)',
        ...
        'storage.titleWarn': 'مساحة التخزين تقترب من الامتلاء',
        'storage.titleUrgent': 'مساحة التخزين شارفت على النفاد',
        'storage.subtitle': 'المستخدَم {{used}} — أي {{pct}}% من حدّ المتصفح. صدّر عملك كملف قبل نفاد المساحة.',
        'storage.snapshots': 'سجلّ التراجع (اللقطات)',
        'storage.logos': 'صور الشعارات',
        'storage.charts': 'بيانات المخططات',
        'storage.other': 'أخرى',
        'storage.unitKB': 'ك.ب',
        'help.copyReport': 'نسخ تقرير التشخيص',
        'storage.titleOk': 'استهلاك التخزين',
        'storage.subtitleOk': 'المستخدَم {{used}} — أي {{pct}}% من حدّ المتصفح. المساحة وافرة، وسيصلك تنبيه عند 75%.',
        'storage.breakdownEmpty': 'لا شيء مخزَّن بعد',
        'storage.actClose': 'إغلاق',
        'storage.unitMB': 'م.ب',
        'storage.hintSnapshots': 'سجلّ التراجع يشغل أكبر مساحة. حذفه للمشاريع المنتهية يحرّر أكثر من أي إجراء آخر، ولا يمسّ بيانات المخططات إطلاقاً.',
        'storage.hintLogos': 'صور الشعارات تشغل مساحة أكبر من المخططات نفسها. حذف شعار من مشروع قديم يحرّر مساحة فوراً.',
        'storage.actExport': 'صدّر هذا المشروع كملف',
        'storage.actPrune': 'احذف سجلّ التراجع للمشاريع الأخرى',
        'storage.actLater': 'لاحقاً',
        'storage.pruneNone': 'لا توجد مشاريع أخرى لتنظيفها.',
        'storage.pruneConfirm': 'حذف سجلّ التراجع لـ {{n}} مشروع آخر؟ بيانات المخططات لا تتأثّر — يُفقد فقط التراجع عن التعديلات السابقة في تلك المشاريع.',
        'storage.pruneDone': 'تم تحرير {{size}} من {{n}} مشروع.',
        ...
        'additionalInfo.renameTitle': 'إعادة تسمية القسم',
        'additionalInfo.clearTitle':  'مسح القسم',
